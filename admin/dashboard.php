...
<div class="main-wrapper">
    ...
    <div class="grid">
        ...
        <div class="card">
            ...
            <a href="add_funds.php" class="btn btn-success btn-sm w-100 mb-1">Add Funds</a>
            <a href="chat.php" class="btn btn-primary btn-sm w-100">Open Chat</a>
        </div>
    ...
    <div class="card" style="margin-top:20px;">
        <h6>Chat Support</h6>
        <p>Message registered users directly from the chat panel.</p>
        <a href="chat.php" class="btn btn-primary btn-sm w-100">Go to Chat</a>
    </div>
